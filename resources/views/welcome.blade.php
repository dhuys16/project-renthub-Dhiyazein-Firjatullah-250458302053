...
@section('content')
    ...
    >
      <div class="container px-4 mx-auto">
        <div class="relative flex items-center justify-evenly -mx-4">
          {{-- logo --}}
          <div class="max-w-full px-4 w-60">
            <a href="/" class="block w-full py-5 navbar-logo flex align-center gap-3">
              <img class="rounded-full w-[80px] h-[80px] mr-[5px]"
                src="{{asset('play/assets/images/logo/RentHub.png')}}"
                alt="logo"
                class="w-full header-logo"
              />
              <h1 class="text-3xl  ml-[5px] font-bold ud-menu-scroll text-dark group-hover:text-primary dark:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70">RentHub</h1>
            </a>
          </div>
          {{-- menu --}}
          <div class="flex items-center justify-between w-full px-4">
            <div>
              ...
              <nav
                id="navbarCollapse"
                class="absolute lg:ml-[110px] right-4 top-full hidden w-full max-w-[250px] rounded-lg bg-white py-5 shadow-lg dark:bg-dark-2 lg:static lg:block lg:w-full lg:max-w-full lg:bg-transparent lg:px-4 lg:py-0 lg:shadow-none dark:lg:bg-transparent xl:px-6"
              >
                <ul class="block lg:flex 2xl:ml-20">
                  <li class="relative group">
                    <a
                      href="#home"
                      class="flex py-2 mx-8 text-xl font-medium ud-menu-scroll text-dark group-hover:text-primary dark:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70"
                    >
                      Home
                    </a>
                  </li>
                  <li class="relative group">
                    <a
                      href="#about"
                      class="flex py-2 mx-8 text-xl font-medium ud-menu-scroll text-dark group-hover:text-primary dark:text-white lg:ml-7 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-10"
                    >
                      About
                    </a>
                  </li>
              ...
              {{-- 🔑 LOGIKA KONDISIONAL DIMULAI DI SINI --}}
                    @auth
                        ...
                        <form method="POST" action="{{ route('logout') }}" class="ml-3">
                            @csrf
                            <button type="submit" class="text-gray-600 hover:text-gray-900 px-4 py-2">
                                Logout
                            </button>
                        </form>

                    @else
                        {{-- BARIS 13 AKAN BERADA DI SINI, KONTEN UNTUK GUEST --}}
                        <a href="{{ route('login') }}" class="text-white px-4 py-2 text-base font-medium hover:opacity-70">
                            Log In
                        </a>
                        <a href="{{ route('register') }}" class="px-6 py-2 text-base font-medium text-white duration-300 ease-in-out rounded-md bg-white/20 signUpBtn hover:bg-white/100 hover:text-dark ml-3">
                            Register
                        </a>
                    @endauth {{-- BLOK KONDISIONAL TERTUTUP --}}
        ...
        <div class="flex flex-wrap items-center -mx-4">
          <div class="w-full px-4">
            ...
            >
              ...
              >
                Pusat Sewa Barang Online Terlengkap & Terpercaya
              </h1>
              <p
                class="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]"
              >
                Temukan dan sewa semua kebutuhan Anda dari ribuan Vendor tepercaya. Solusi efisien tanpa komitmen kepemilikan.
              </p>
              <ul
          ...
          <div class="w-full px-4">
            ...
            >
              <div class="mt-16">
                <img
                  src="{{asset('play/assets/images/hero/hero-image.jpg')}}"
                  alt="hero"
...
<!-- ====== About Section Start -->
          ...
          <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full px-4 lg:w-1/2">
              <div class="mb-12 max-w-[540px] lg:mb-0">
                ...
                >
                  RentHub: Pusat Koneksi Vendor dan Kebutuhan Sewa Anda.
                </h2>
                <p
                  class="mb-10 text-base leading-relaxed text-body-color dark:text-dark-6"
                >
                  RentHub adalah marketplace sewa-menyewa yang menghubungkan pemilik aset (Vendor) dengan pihak yang membutuhkan (Penyewa) melalui platform digital yang aman dan transparan. Kami menyediakan sistem booking berbasis tanggal secara real-time yang menghilangkan risiko double-booking dan memastikan transaksi yang cepat. Dengan fitur multi-role dan dashboard analisis kinerja, RentHub adalah solusi efisien untuk memaksimalkan aset dan memenuhi kebutuhan sewa jangka pendek Anda.
                </p>
            ...
            <div class="w-full px-4 lg:w-1/2">
              <div class="flex flex-wrap -mx-2 sm:-mx-4 lg:-mx-2 xl:-mx-4">
                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  ...
                  >
                    <img
                      src="{{asset('play/assets/images/about/about-image-01.jpg')}}"
                      alt="about image"
                ...
                <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  ...
                  >
                    <img
                      src="{{asset('play/assets/images/about/about-image-02.jpg')}}"
                      alt="about image"
                      class="object-cover object-center w-full h-full"
                    />
                  </div>
    ...
    <section
      id="product"
      class="overflow-hidden  py-20 bg-white dark:bg-dark md:py-[120px]"
    >
      <div class="container px-4 mx-auto">
        <div class="flex flex-wrap justify-center -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[600px] text-center">
              ...
              <h2
                class="mb-3 text-3xl font-bold leading-[1.3] text-dark dark:text-white sm:text-4xl md:text-[40px]"
              >
                Yang Bisa Anda Temukan
              </h2>
              <p class="text-base text-body-color dark:text-dark-6">
                Kami hanya menghadirkan barang sewa berkualitas terbaik dengan ulasan terverifikasi. Sewa dengan percaya diri, tanpa kompromi.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="p-5 swiper testimonial-carousel common-carousel">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div
                  class="rounded-xl h-[500px] bg-white px-4 py-[30px] shadow-testimonial dark:bg-dark sm:px-[30px]"
                > 
                <div class="bg-gray-1 dark:bg-dark-2 px-[5px] py-[5px] border-white dark:border-dark rounded-[10px]">
                  <img src="{{asset('play/assets/images/testimonials/Toyota Kijang Innova.jpg')}}" alt="foto produk" class="w-[292px] border-grey-1dark:border-dark2 rounded-[10px]">
                </div>
                  <h3 class="mb-6 mt-5 text-xl text-body-color dark:text-dark-6">
                    Mobil Toyota Kijang Innova 2020
                  </h3>
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <div class="bg-gray-1 dark:bg-dark-2 px-[5px] py-[5px] border-white dark:border-dark rounded-[10px]">
                  <img src="{{asset('play/assets/images/testimonials/motor nmax.jpg')}}" alt="foto produk" class="w-[292px] border-grey-1dark:border-dark2 rounded-[10px]">
                </div>
                  <h3 class="mb-6 mt-5 text-xl text-body-color dark:text-dark-6">
                    Motor NMax 2021
                  </h3>
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <div class="bg-gray-1 dark:bg-dark-2 px-[5px] py-[5px] border-white dark:border-dark rounded-[10px]">
                  <img src="{{asset('play/assets/images/testimonials/speaker horeg.jpg')}}" alt="foto produk" class="w-[292px] border-grey-1dark:border-dark2 rounded-[10px]">
                </div>
                  <h3 class="mb-6 mt-5 text-xl text-body-color dark:text-dark-6">
                    Speaker Dat
                  </h3>
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <div class="bg-gray-1 dark:bg-dark-2 px-[5px] py-[5px] border-white dark:border-dark rounded-[10px]">
                  <img src="{{asset('play/assets/images/testimonials/Sony alpha 7S.jpg')}}" alt="foto produk" class="w-[292px] border-grey-1dark:border-dark2 rounded-[10px]">
                </div>
                  <h3 class="mb-6 mt-5 text-xl text-body-color dark:text-dark-6">
                    Kamera DSLR Sony Alpha 7S
                  </h3>
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <div class="bg-gray-1 dark:bg-dark-2 px-[5px] py-[5px] border-white dark:border-dark rounded-[10px]">
                  <img src="{{asset('play/assets/images/testimonials/kawasaki ninja 300.jpg')}}" alt="foto produk" class="w-[292px] border-grey-1dark:border-dark2 rounded-[10px]">
                </div>
                  <h3 class="mb-6 mt-5 text-xl text-body-color dark:text-dark-6">
                    Motor Kawasaki Ninja 300 2022
                  </h3>
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <div class="bg-gray-1 dark:bg-dark-2 px-[5px] py-[5px] border-white dark:border-dark rounded-[10px]">
                  <img src="{{asset('play/assets/images/testimonials/DJI Mini 3 Pro..jpg')}}" alt="foto produk" class="w-[292px] border-grey-1dark:border-dark2 rounded-[10px]">
                </div>
                  <h3 class="mb-6 mt-5 text-xl text-body-color dark:text-dark-6">
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            ...
            >
              <div class="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img
                  src="{{asset('play/assets/images/team/team-01.png')}}"
                  alt="team image"
            ...
            <div class="mb-10 wow fadeInUp group" data-wow-delay=".1s">
              <div class="mb-8 overflow-hidden rounded-[5px]">
                <a href="blog-details.html" class="block">
                  <img
                    src="{{asset('play/assets/images/blog/blog-01.jpg')}}"
                    alt="image"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="mb-10 wow fadeInUp group" data-wow-delay=".15s">
              <div class="mb-8 overflow-hidden rounded-[5px]">
                <a href="blog-details.html" class="block">
                  <img
                    src="{{asset('play/assets/images/blog/blog-02.jpg')}}"
                    alt="image"
                    class="w-full transition group-hover:rotate-6 group-hover:scale-125"
                  />
                </a>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="mb-10 wow fadeInUp group" data-wow-delay=".2s">
              <div class="mb-8 overflow-hidden rounded-[5px]">
                <a href="blog-details.html" class="block">
                  <img
                    src="{{asset('play/assets/images/blog/blog-03.jpg')}}"
                    alt="image"
                    class="w-full transition group-hover:rotate-6 group-hover:scale-125"
                  />
                </a>
      ...
      <div class="container px-4 mx-auto">
        ...
        >
          <a href="https://graygrids.com/">
            <img
              src="{{asset('play/assets/images/brands/graygrids.svg')}}"
              alt="graygrids"
              class="dark:hidden"
            />
            <img
              src="{{asset('play/assets/images/brands/graygrids-white.svg')}}"
              alt="graygrids"
          ...
          <a href="https://lineicons.com/">
            <img
              src="{{asset('play/assets/images/brands/lineicons.svg')}}"
              alt="lineicons"
              class="dark:hidden"
            />
            <img
              src="{{asset('play/assets/images/brands/lineicons-white.svg')}}"
              alt="graygrids"
              class="hidden dark:block"
            />
          </a>
          <a href="https://uideck.com/">
            <img
              src="{{asset('play/assets/images/brands/uideck.svg')}}"
              alt="uideck"
              class="dark:hidden"
            />
            <img
              src="{{asset('play/assets/images/brands/uideck-white.svg')}}"
              alt="graygrids"
              class="hidden dark:block"
            />
          </a>
          <a href="https://ayroui.com/">
            <img
              src="{{asset('play/assets/images/brands/ayroui.svg')}}"
              alt="ayroui"
              class="dark:hidden"
            />
            <img
              src="{{asset('play/assets/images/brands/ayroui-white.svg')}}"
              alt="graygrids"
              class="hidden dark:block"
            />
          </a>
          <a href="https://tailgrids.com/">
            <img
              src="{{asset('play/assets/images/brands/tailgrids.svg')}}"
              alt="tailgrids"
              class="dark:hidden"
            />
            <img
              src="{{asset('play/assets/images/brands/tailgrids-white.svg')}}"
              alt="graygrids"
              class="hidden dark:block"
            />
          </a>
    ...
    >
        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div class="w-full mb-10">
              ...
              >
                <img
                  src="{{asset('play/assets/images/logo/logo-white.svg')}}"
                  alt="logo"
                  class="max-w-full"
                />
              </a>
              ...
              <div class="flex flex-col gap-8">
                ...
                >
                  <div class="overflow-hidden rounded-sm">
                    <img
                      src="{{asset('play/assets/images/blog/blog-footer-01.jpg')}}"
                      alt="blog"
                    />
                  </div>
                  <span
                ...
                >
                  <div class="overflow-hidden rounded-sm">
                    <img
                      src="{{asset('play/assets/images/blog/blog-footer-02.jpg')}}"
                      alt="blog"
                    />
                  </div>
                  <span
      ...
      <div>
        <span class="absolute left-0 top-0 z-[-1]">
          <img src="{{asset('play/assets/images/footer/shape-1.svg')}}" alt="" />
        </span>

        <span class="absolute bottom-0 right-0 z-[-1]">
          <img src="{{asset('play/assets/images/footer/shape-3.svg')}}" alt="" />
        </span>
    ...
    <script src="{{asset('play/assets/js/swiper-bundle.min.js')}}"></script>
    <script src="{{asset('play/assets/js/main.js')}}"></script>
    <script>
      // ==== for menu scroll
