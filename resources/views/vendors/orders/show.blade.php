            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-lg border border-gray-200">
                    ...
                    @if ($currentStatus === 'pending')
                        ...
                        <form action="{{ route('vendors.orders.reject', $order) }}" method="POST" class="w-full">
                            ...
                            <button type="submit" 
                                    ...
                                    class="w-full px-4 py-3 text-red-600 font-medium rounded-lg border border-red-300 !bg-red-100 hover:bg-red-50 transition duration-150">
                                ❌ Tolak Pesanan
                            </button>
                        </form>
                    ...
                    @elseif ($currentStatus === 'rented')
                        ...
                        <p class="text-sm text-gray-600 mb-4  text-cyan-700">Barang saat ini sedang disewa oleh pelanggan.</p>
