      ...
      <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
          ...
          <li class="mt-0.5 w-full">
            <a class="{{ request()->routeIs('vendors.dashboard') ? 'bg-blue-500/13 font-semibold text-slate-700' : 'text-slate-500' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors hover:bg-gray-100 dark:text-white dark:opacity-80" href="{{ route('vendors.dashboard') }}">
          ...
          <li class="mt-0.5 w-full">
            <a class="{{ request()->is('vendors.products.index') ? 'bg-blue-500/13 font-semibold text-slate-700' : 'text-slate-500' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors hover:bg-gray-100 dark:text-white dark:opacity-80" href="{{(route('vendors.products.index'))}}">
              <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                <i class="relative top-0 text-sm leading-normal text-slate-700 ni ni-app"></i>
              </div>
          ...
          <li class="mt-0.5 w-full">
            <a class="{{ request()->is('vendors.orders.index') ? 'bg-blue-500/13 font-semibold text-slate-700' : 'text-slate-500' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors hover:bg-gray-100 dark:text-white dark:opacity-80" href="{{route('vendors.orders.index')}}">
              <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                <i class="relative top-0 text-sm leading-normal text-yellow-500 fa-solid fa-list"></i>
              </div>
